...
# Compare with original features (using a subset for efficiency)
print("\nComparing with original features (using a sample)...")
...
X_orig = df_sample[feature_cols].values
y_orig = df_sample['label'].values
